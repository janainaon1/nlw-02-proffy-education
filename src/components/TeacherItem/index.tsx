...
function TeacherItem() {
  return (
    <article className="teacher-item">
      <header>
        <img src="https://avatars1.githubusercontent.com/u/66140932?s=460&u=eae69df15eeeb5684c7eecdaf78b689c56a357a5&v=4" alt="Janaina Oliveira"/>
        <div>
          <strong>Janaina Oliveira</strong>
          <span>Química</span>
        </div>
      </header>
